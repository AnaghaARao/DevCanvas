...
def generate_combined_pdf(contents, output_file):
    ...
    def create_header_footer(canvas, width, height):
        ...
        canvas.drawString(120, header_top - 25, "DevCanvas")
        
        # Add report generation date
        canvas.setFont("Helvetica", 10)
        canvas.setFillColor(colors.Color(0.4, 0.4, 0.4))
        date_str = datetime.now().strftime("%B %d, %Y")
        canvas.drawString(width - 150, header_top - 25, f"Generated: {date_str}")
        
        # Header separation line
        canvas.setStrokeColor(colors.Color(0.8, 0.8, 0.8))
        canvas.line(50, header_top - 45, width - 50, header_top - 45)
        
        # Footer separation line
        canvas.line(50, 60, width - 50, 60)
        
        # Footer text
        canvas.setFont("Helvetica", 9)
        canvas.setFillColor(colors.Color(0.4, 0.4, 0.4))
        canvas.drawString(72, 45, "© Generated by DevCanvas")
        
        # Add page number
        page_num = canvas.getPageNumber()
        canvas.drawRightString(width - 72, 45, f"Page {page_num}")
    ...
    header_footer_spacing = 100  # Increase space below header
    ...
    for content in contents:
        ...
        for line in lines:
            ...
            if text_y < 80:  # Adjust for footer space
                # Draw header and footer before starting a new page
    ...
    # Draw header and footer on the last page
    create_header_footer(c, width, height)
    c.save()
