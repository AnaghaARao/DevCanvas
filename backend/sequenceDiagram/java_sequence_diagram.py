...
class JavaSequenceDiagramGenerator:
        ...
        try:
            with open(file_path, 'r', encoding='utf-8') as file:
                ...
                if not class_name:
                    ...
                    return {
                        'status':'error',
                        'error':f'Could not find class name in {file_path}'
                    }
                ...
                return {
                    'status':'success',
                    'success':f"Successfully analyzed: {os.path.basename(file_path)}"
                }
    ...
    def analyze_directory(self):
        ...
        if not java_files:
            ...
            return {
                'status':'error',
                'error':f'No Java files found in {self.directory}'
            }
...
"""
    ...
    def generate_pdf(self, output_path: str = None, sequence_png_path: str = None):
        if not self.messages:
        ...
        try:
            ...
            if not plantuml_str:
                return {
                    'status':'error',
                    'error':'plantuml str not generated'
                }
            ...
            return {
                'status':'success',
                'success':f'Generated PDF sequence diagram: {output_path}'
            }
